    ...
    table: {
        __generateDTRow(data){ 
            return [
                ...
                data.address,   
                data.prices,    
                data.status == 1 ? 'Chưa hoàn thiện' : 'Đã hoàn thiện',     
        ...
        init(){
            var row_table = [ 
                                ...
                                { title: 'Tên khách', name: 'name', orderable: true, },  
                                { title: 'Địa chỉ', name: 'name', orderable: true, },  
                                { title: 'Tổng tiền', name: 'name', orderable: true, },  
                                { title: 'Trạng thái', name: 'name', orderable: true, },  
