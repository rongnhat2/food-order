...
@section('menu-data')
<input type="hidden" name="" class="menu-data" value="ingredient-group | ingredient">
@endsection()
                ...
                <div class="card-body">   
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label control-label">Tên nguyên liệu</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control data-name" placeholder="">
                            </div>
                        </div>   
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label control-label">Phân loại</label>
                            <div class="col-md-8">
                                <select name="" id="" class="form-control data-type">
                                    <option value="1">Nguyên liệu thô</option>
                                    <option value="2">Đã sơ chế</option>
                                </select> 
                            </div>
                        </div>   
...
@section('js')
    ...
    <script src="{{ asset('manager/assets/js/page/ingredient.js') }}"></script>
