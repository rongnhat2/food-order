...
@section('title', 'Bếp')
@section('menu-data')
<input type="hidden" name="" class="menu-data" value="kitchen-group | kitchen">
@endsection()
                ...
                <div class="card-body">   
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label control-label">Tên bếp</label>
                            <div class="col-md-8">
...
@section('js')
    ...
    <script src="{{ asset('manager/assets/js/page/kitchen.js') }}"></script>
