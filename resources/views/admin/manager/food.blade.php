...
@section('menu-data')
<input type="hidden" name="" class="menu-data" value="food-group | food">
@endsection()
                ...
                <div class="card-body">   
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-8">
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Tên món</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Hệ số</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control data-coefficient number-type" placeholder="">
                                    </div>
                                </div> 
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label control-label">Đơn giá</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control data-price number-type" placeholder="">
                                    </div>
                                </div> 
                            <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            ...
                            <button class="btn btn-primary igredient-create" atr="Create">Thêm nguyên liệu</button>
                        </div>
                    </div>       
...
@section('js')
    ...
    <script src="{{ asset('manager/assets/js/page/food.js') }}"></script>
